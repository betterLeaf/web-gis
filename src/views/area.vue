...
import useMapMove from '../hooks/mapMove'
const mapMove = useMapMove()

import areaGeo from "../assets/100000.json";
...
function initMap() {
    ...
    // echartsLayer.appendTo(map.value);
}
...
function addArea(geo = []) {
    ...
    areaLayer.value.getSource().addFeatures([areaFeature]);
}
